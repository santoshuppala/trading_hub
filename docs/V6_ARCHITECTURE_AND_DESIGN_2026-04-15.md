...
|--------|------|-----------|
| FRED | Fed funds, yield curve, VIX | Session |
| Fear & Greed | Market sentiment (0-100) | 10 min |
| Finviz | Short float, insider trading | Periodic |
| SEC EDGAR | Recent filings (10-K, 8-K) | Session |
| Alpha Vantage | SMA, EMA, RSI, fundamentals | 24 hr |
| Polygon | Prev day OHLCV, ticker details | 1 hr |
| Reddit | WSB/stocks mention counts | 5 min |
| Unusual Whales | Options flow | 10 min |
